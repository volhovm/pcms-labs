...
public class B_twoThreeTree {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                switch (query) {
                    case "put":
                        bst.add(scin.nextInt());
                        break;
                    case "exists":
                        scout.println(bst.contains(scin.nextInt()));
                        break;
                    case "delete":
                        bst.remove(scin.nextInt());
                        break;
                    case "next":
    ...
    final static class HoleNode extends Node {
        private Node child;
